...
<div style="display: flex;">
  <img src="/assets/images/pub/roma23_geom.png" style="flex: 1; object-fit: cover;">
  <img src="/assets/images/pub/roma23_geom.png" style="flex: 1; object-fit: cover;">
</div>

3D Scene geometry can be compactly represented using a 2D texture map: occupancy map (OM).
